...
function readManifest(skillRoot = path.resolve(__dirname, '..')) {
  const manifest = JSON.parse(fs.readFileSync(path.join(skillRoot, 'skill.json'), 'utf8'));
